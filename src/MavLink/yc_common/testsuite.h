/** @file
 *	@brief MAVLink comm protocol testsuite generated from yc_common.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef YC_COMMON_TESTSUITE_H
#define YC_COMMON_TESTSUITE_H
...
static void mavlink_test_yc_common(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_yc_common(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_adsb_short(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_adsb_short_t packet_in = {
		963497464,
	}45.0,
	}73.0,
	}101.0,
	...
	mavlink_adsb_short_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.address = packet_in.address;
        	packet1.latitude = packet_in.latitude;
        	packet1.longitude = packet_in.longitude;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adsb_short_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_adsb_short_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adsb_short_pack(system_id, component_id, &msg , packet1.address , packet1.latitude , packet1.longitude , packet1.altitude , packet1.h_velocity , packet1.v_velocity , packet1.heading );
	mavlink_msg_adsb_short_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adsb_short_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.address , packet1.latitude , packet1.longitude , packet1.altitude , packet1.h_velocity , packet1.v_velocity , packet1.heading );
	mavlink_msg_adsb_short_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_adsb_short_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adsb_short_send(MAVLINK_COMM_1 , packet1.address , packet1.latitude , packet1.longitude , packet1.altitude , packet1.h_velocity , packet1.v_velocity , packet1.heading );
	mavlink_msg_adsb_short_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_yc_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_adsb_short(system_id, component_id, last_msg);
}

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // YC_COMMON_TESTSUITE_H
