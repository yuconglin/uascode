...
public slots:
    ...
    /** @brief update the obstacles' positions on the map */
    void updateAdsb3(UASInterface* uas, 
    ...
    void updateAdsb(UASInterface* uas, quint32 addr, float lat, float lon, float yaw);
...
protected:
    /*added by Yucong, for obstacle color distinction*/
    //no red
    int ADSB_COLOR[7][3]=
    ...
    //added by Yucong Lin, for adsb
    QMap<int,mapcontrol::UAVItem*> ADSBs;
    //added by Yucong Lin, for trail and icon color
    QMap<int,QColor> ADDRESS_COLORs;
